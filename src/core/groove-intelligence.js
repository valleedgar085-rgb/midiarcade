...
export const GENRE_GROOVE_GRAMMARS = Object.freeze({
  ...
  techno: Object.freeze({
    id: "techno-four-floor-machine",
    philosophy: "four-floor-machine-pulse-offbeat-motion-controlled-evolution",
    base: Object.freeze({
      kick: Object.freeze([0, 4, 8, 12]),
      snare: Object.freeze([4, 12]),
      hat: Object.freeze([2, 6, 10, 14]),
    ...
    probability: Object.freeze({ kick: 1, snare: 0.94, hat: 0.98, percussion: 0.66 }),
    locked: Object.freeze({ kick: Object.freeze([0, 4, 8, 12]), snare: Object.freeze([4, 12]), hat: Object.freeze([2, 6, 10, 14]), percussion: Object.freeze([]) }),
    density: Object.freeze({ kick: 1, snare: 1, hat: 1.08, percussion: 0.9 }),
    transforms: Object.freeze([
      Object.freeze({ lane: "percussion", type: "euclid", pulses: 5, steps: 16, rotateEvery: 2 }),
      Object.freeze({ lane: "hat", type: "intensifySection", sections: Object.freeze(["build", "payoff"]), amount: 1.18 }),
    ]),
    relationships: Object.freeze({
      bass: Object.freeze({ source: "hat", mode: "offbeat-machine-interlock", lock: 0.82, answerDelayBeats: 0, syncopation: 0.5 }),
      chords: Object.freeze({ source: "hat", mode: "machine-offbeat-comp", offsetBeats: 0, syncopation: 0.48 }),
      lead: Object.freeze({ source: "kick", mode: "machine-phrase-grid", offsetBeats: 0.5, syncopation: 0.4 }),
    }),
    humanization: Object.freeze({ timing: 0.006, velocity: 0.06, swing: 0.02, laidBackBeats: 0 }),
    polyrhythm: Object.freeze({ percussionSteps: 16, pulses: 5 }),
  }),
  drumBass: Object.freeze({
    id: "drum-bass-breakbeat-drive",
    philosophy: "breakbeat-kick-snare-drive-fast-subdivision-bass-reply",
    base: Object.freeze({
      kick: Object.freeze([0, 7, 11, 14]),
      snare: Object.freeze([4, 12]),
      hat: Object.freeze([0, 2, 4, 6, 8, 10, 12, 14]),
      percussion: Object.freeze([3, 9, 15]),
    }),
    probability: Object.freeze({ kick: 0.88, snare: 1, hat: 0.96, percussion: 0.56 }),
    locked: Object.freeze({ kick: Object.freeze([0]), snare: Object.freeze([4, 12]), hat: Object.freeze([]), percussion: Object.freeze([]) }),
    density: Object.freeze({ kick: 1.02, snare: 1, hat: 1.2, percussion: 0.84 }),
    transforms: Object.freeze([
      Object.freeze({ lane: "hat", type: "tripletTurn", every: 4, chance: 0.34 }),
      Object.freeze({ lane: "hat", type: "burstEvery", every: 3, count: 3, spacingSteps: 0.6667, chance: 0.26 }),
      Object.freeze({ lane: "kick", type: "rotateEvery", every: 2, amount: 1, chance: 0.32 }),
    ]),
    relationships: Object.freeze({
      bass: Object.freeze({ source: "kick", mode: "breakbeat-reply", lock: 0.7, answerDelayBeats: 0.5, syncopation: 0.66 }),
      chords: Object.freeze({ source: "snare", mode: "breakbeat-space", offsetBeats: 0, syncopation: 0.42 }),
      lead: Object.freeze({ source: "hat", mode: "fast-phrase-over-break", offsetBeats: 0.25, syncopation: 0.58 }),
    }),
    humanization: Object.freeze({ timing: 0.012, velocity: 0.09, swing: 0.04, laidBackBeats: 0 }),
    polyrhythm: Object.freeze({ percussionSteps: 12, pulses: 5 }),
  }),
...
const GROOVE_CELL_POLICIES = Object.freeze({
  ...
  drumBass: Object.freeze({
    ...
    lanes: Object.freeze({
      kick: Object.freeze([0, 2, 3, 6, 7, 10, 11, 14, 15]),
      snare: Object.freeze([4, 5, 11, 12, 13]),
      hat: Object.freeze([0, 1, 2, 3, 4, 6, 7, 8, 9, 10, 11, 12, 14, 15]),
      percussion: Object.freeze([3, 7, 9, 11, 15]),
    }),
  }),
  general: Object.freeze({
    protectedSpaces: Object.freeze([3, 11]),
