...
export const CREATE_CONTROL_CONTRACT = Object.freeze({
  ...
  trapIntroModeControl: entry("Trap / Hip-Hop intro build", "Trap and Hip-Hop only: keep the immediate intro or give the drums a deterministic double-length build. Other genres ignore this choice.", "advanced"),
