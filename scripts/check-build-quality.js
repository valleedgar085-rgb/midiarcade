...
const orangeStudioCss = await readFile(path.join(projectRoot, "www/orange-studio.css"), "utf8");
...
if (!html.includes('href="./orange-studio.css"')) failures.push("Orange Studio stylesheet is not linked from the built app");
...
if (!orangeStudioCss.includes("--figma-orange:#ff5500")) failures.push("Orange Studio design tokens are missing from the shipped stylesheet");
for (const [relativePath, source] of [
  ...
  ["www/orange-studio.css", orangeStudioCss],
  ["www/src/app.js", app],
